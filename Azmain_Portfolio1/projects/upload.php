...
<body>
    ...
    if (isset($_POST['form_submit'])) {
        ...
        if (!isset($error)) {
            ...
            $result = mysqli_query($db, "INSERT INTO projects(image,title,description,weblink,demolink) VALUES('$image_file','$title','$description','$weblink','$demolink')");
            if ($result) {
    ...
    <div class="container_section">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" name="demolink" class="form-control" required>
            <br><br>
