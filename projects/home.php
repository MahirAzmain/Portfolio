...
<body>
    <div class="container_display">
        ...
        <table cellpadding="10">
            <tr>
                <th colspan='6'><span style="float:right;"><a href="upload.php"><button class="btn-primary">Add new project</button></a></span></th>
            </tr>
            <tr>
                <th>Project Image</th>
                <th>Project Name</th>
            ...
            while ($row = mysqli_fetch_array($res)) {
                echo '<tr> 
                  <td><img src="uploads/' . $row['image'] . '" height="200px" width="300px"></td> 
                  <td>' . $row['title'] . '</td> 
